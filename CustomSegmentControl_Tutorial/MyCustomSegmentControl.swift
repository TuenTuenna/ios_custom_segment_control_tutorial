...
#if DEBUG
import SwiftUI
struct MyCustomSegmentControlRepresentable: UIViewRepresentable {
func updateUIView(_ uiView: UIView,context: Context) {
        // leave this empty
}
@available(iOS 13.0.0, *)
func makeUIView(context: Context) -> UIView{
    MyCustomSegmentControl()
    }
}
@available(iOS 13.0, *)
struct MyCustomSegmentControl_PreviewProvider: PreviewProvider {
    static var previews: some View {
        Group {
            MyCustomSegmentControlRepresentable()
